...
svn export https://github.com/haiibo/packages/trunk/luci-app-vssr package/helloworld/luci-app-vssr
git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall package/helloworld/openwrt-passwall
